...
module "network" {
  source               = "git@github.com:Salesfloor/mbm-terraform-module-networking.git?ref=v0.1.0"
...
module "instances" {
  ...
  source           = "git@github.com:Salesfloor/mbm-terraform-module-mac-instances.git?ref=v0.1.0"
